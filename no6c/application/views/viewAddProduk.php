            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        <?php echo form_open('Home/addProduct', array('class' => 'form-horizontal', 'role' => 'form' )); ?>
                            ...
                            <div class="form-group ic-cmp-int col-lg-12">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="id" name="id" class="form-control" placeholder="ID Product">
                                </div>
                            </div>
                            ...
                            <div class="form-group ic-cmp-int col-lg-12">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="price" name="price" class="form-control" placeholder="Harga Produk">
                                </div>
                            </div>
