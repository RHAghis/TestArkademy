                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $list->cashier ?></td>
                                        <td><?php echo $list->product ?></td>
                                        <td><?php echo $list->category ?></td>
                                        <td><?php echo $list->price ?></td>
                                        <td>
                                            <div class="button-icon-btn button-icon-btn-cl sm-res-mg-t-30">
                                                <a href="<?php echo site_url() ?>/Home/editProduct/<?php echo $list->id ?>"><button class="btn btn-primary primary-icon-notika" ><i class="notika-icon notika-edit"></i></button></a>
                                                <a class="tmbl-hapus" href="<?php echo site_url() ?>/Home/delProduct/<?php echo $list->id ?>"><button class="btn btn-danger danger-icon-notika" ><i class="notika-icon notika-trash"></i></button></a>
                                            </div>
                                        </td>
                                    </tr>
